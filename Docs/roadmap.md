...
собственными HTML/PNG и больше не затрагивает отчёты обхода; подробный baseline
необходимо снять повторно.
...
- **[#68](https://github.com/arvidsever/Sudrf/issues/68) + [#65](https://github.com/arvidsever/Sudrf/issues/65)** — диагностика источников и независимый live canary.
  ...
  поэтому для host-level выводов требуется повторный обход.
