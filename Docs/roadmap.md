...
Текущий baseline: **main 0.58.16**, build 186. Полный локальный набор:
1398 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
Приёмка #247 проведена на сохранённом хранилище из 470 дел с резервной копией.
...
Сверка 16 сентября 2026 года: после завершения #247 остаётся 55 открытых issues.
