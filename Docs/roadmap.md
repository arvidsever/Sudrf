...
Текущий baseline: **0.58.36**, build 206; локальный полный набор: 1529 XCTest
...
|---|---|---|---|
| 0.58.36 | [#322](https://github.com/arvidsever/Sudrf/issues/322) | Нижестоящие карточки московского портала подтверждаются и объединяются с апелляцией/кассацией SUDRF; известные карточки 1 АСОЮ обновляются напрямую. | PR после проверки |
