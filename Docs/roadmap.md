...
Текущий baseline: **main 0.55.0**, build 156, 1069 тестов (5 пропущены). Следующая
пользовательская функция или новый источник — 0.56.0.
...
- **#164** проходит в два доказательных шага. 0.53.2 локально накапливает только
  ...
  после завершённой #94 ближайшая задача — **#74**.
...
| --- | --- |
| Уже выполнены #64, #79, #81, #82, #88, #89, #90, #91, #94, #110, #117, #130, #132, #151, #207, #210, #211, #213, #219, #220 и identity/reconciliation foundation | #74 — ближайшая готовая задача |
| #88 + этап 1 #164 | #92: добавление дела по URL использует единый надёжный CAPTCHA/session flow |
| Выполненные #89 + #94 + #132 + #90 + #130 | #74: движение уже найденных материалов |
...
#94 завершена; #74 разблокирована typed source outcomes и консервативным cache merge.
Ближайшая задача — #74. #93 ждёт именно event contract,
