...
Текущий baseline: **main 0.57.6**, build 167, 1188 XCTest (5 пропущены) и 14 Swift Testing. Полный
...
После merge #269 и регистрации #271 остаются
...
- **[#271](https://github.com/arvidsever/Sudrf/issues/271)** — в работе: восстановление карточки КСОЮ должно узнавать номер принятого производства в составном заголовке `8а-… [88а-…]`, а также согласованные гражданские и уголовные пары. Проверки суда, картотеки, УИД и уникальности сохраняются; временный отказ не разрешает замену ссылки. Часть надёжности импорта #248.
