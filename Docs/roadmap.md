...
|---|---|---|---|
| 0.58.34 | [#321](https://github.com/arvidsever/Sudrf/issues/321) | Переданные дела КоАП открываются на опубликованном домене принимающего суда и атомарно становятся текущей регистрацией без ложных копий. | — |
...
Сверка 25 сентября 2026 года: после завершения #321 остаётся 44 открытых issues.
