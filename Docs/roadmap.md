...
Текущий baseline: **main 0.58.26**, build 196. Полный локальный набор:
1438 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
...
ручной очереди после полезного partial-обновления; #238 о прямых `sourceURL`
...
|---|---|---|---|
| 0.58.26 | [#237](https://github.com/arvidsever/Sudrf/issues/237) | Вышестоящие суды обновляются независимо при недоступности базовой карточки по подтверждённому сохранённому УИД. | — |
...
Сверка 22 сентября 2026 года: после завершения #237 остаётся 45 открытых issue.
...
- **[#238](https://github.com/arvidsever/Sudrf/issues/238)** — использовать сохранённые точные URL вышестоящих карточек независимо
  от доступности поиска; discovery по УИД сохранить. Следует за выполненным [#237](https://github.com/arvidsever/Sudrf/issues/237).
