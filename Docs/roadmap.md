...
Текущий baseline: **main 0.58.23**, build 193. Полный локальный набор:
1418 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
...
Сверка 20 сентября 2026 года: после завершения #312 остаётся 49 открытых issue.
...
- **[#288](https://github.com/arvidsever/Sudrf/issues/288)** — установить новую регистрацию дела Беляева `9-727/2020` по официальной связи или точному УИД. После обнаружения карточки использовать выполненный в #246 общий выбор актуальной регистрации.
