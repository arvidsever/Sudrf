...
Текущий baseline: **main 0.58.12**, build 182. Последняя зафиксированная полная локальная
...
- **0.58.12 / #291:** доменные алиасы и три карточки Самары подтверждены штатным обновлением и перезапуском; PR [#298](https://github.com/arvidsever/Sudrf/pull/298) влит. Полная хронология апелляций продолжена отдельно в #300.
...
### Апелляционная хронология и текущая стадия

- **[#300](https://github.com/arvidsever/Sudrf/issues/300)** — сохранять все подтверждённые апелляционные карточки в общей хронологии, убрать значок ЧЖ; стадия и сроки учитывают последующее принятие и продолжающуюся первую инстанцию. Реализация и приёмка в `codex/appeal-chronology-300`; #247 целиком не закрывается.
