...
- `swift test` — 495 тестов, успешно после добавления этапов 0–6; тот же полный
...
- Первый и второй self-review оказались недостаточно adversarial: они пропустили
  инъекцию локальных AI-полей через schema-less provider и reentrant гонку
  Spotlight disable с уже начатым write. Эти выводы явно отозваны; после нового
  коммита требуется третий self-review и ещё один независимый проход коллеги.
