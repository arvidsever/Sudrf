...
Текущий baseline: **main 0.48.0**, build 145, 918 тестов (5 пропущены). Следующее
исправление — 0.48.1; следующая пользовательская функция или новый источник — 0.49.0.
...
совпадает. После merge #151 все 49 открытых issues перечислены в этом разделе.
...
- **#213** — загружать и единообразно отображать опубликованные файловые акты
  DOC, DOCX и PDF, не принимая HTML/CAPTCHA за документ; prerequisite #151 выполнен.
...
| --- | --- |
| Уже выполнены #64, #79, #81, #82, #91, #117, #151, #210 и identity/reconciliation foundation | Готовая очередь #213, #211 и #110; #94 и #74 тоже архитектурно готовы, но стоят сразу после текущего source gate из-за большего scope |
