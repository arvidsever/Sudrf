...
struct CaseEventDeriverTests {
    ...
    @Test func derivationVersionFiveBaselinesVersionFourProjectionAndPreservesJournal() throws {
        ...
        #expect(CaseEventJournal.currentDerivationVersion == 5)
