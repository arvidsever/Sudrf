...
Текущий baseline: **main 0.53.0**, build 150, 979 тестов (5 пропущены). Следующее
исправление — 0.53.1; следующая пользовательская функция или новый источник — 0.54.0.
...
- Продолжается source gate **#88 + #164 + #89 + #207**. Зависимые задачи из
...
| --- | --- |
| Уже выполнены #64, #79, #81, #82, #91, #110, #117, #151, #210, #211, #213, #219, #220 и identity/reconciliation foundation | #94 и #74 архитектурно готовы, но стоят сразу после текущего source gate из-за большего scope |
