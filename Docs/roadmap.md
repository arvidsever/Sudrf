...
Текущий baseline: **main 0.46.7**, build 134, 852 теста (5 пропущены). Следующее
исправление — 0.46.8; следующая пользовательская функция или новый источник — 0.47.0.
...
совпадает. Все 54 открытых issues перечислены в этом разделе.
