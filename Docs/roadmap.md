...
Текущий baseline: **main 0.58.6**, build 176, 1278 XCTest (5 пропущены) и 21 Swift Testing. Полный
...
Все открытые GitHub Issues распределены ниже как текущие, зависимые или отложенные.
...
- **[#284](https://github.com/arvidsever/Sudrf/issues/284)** — опубликованный номер принятого дела КАС вместо М/9а; общий выбор актуальной регистрации, сохранение предыдущих карточек и поиск по прежним номерам. Реализация, 1310 XCTest / 21 Swift Testing, Xcode 27 и живая приёмка трёх М-регистраций завершены; слияние ещё не выполнено. Полная классификация #247 и гражданский объём #246 остаются отдельно.
...
- **[#291](https://github.com/arvidsever/Sudrf/issues/291)** — установить точную вышестоящую карточку дела `3а-673/2026`, проверить запуск обновления, поиск и связывание. Конкретная приёмка #87/#238; наличие УИД не означает успешную загрузку цепочки, смена номера из #284 не закрывает этот дефект.
