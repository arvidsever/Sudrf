...
Текущий baseline: **main 0.52.0**, build 149, 962 теста (5 пропущены). Следующее
исправление — 0.52.1; следующая пользовательская функция или новый источник — 0.53.0.
...
совпадает. После merge #220 все 53 открытых issues перечислены в этом разделе.
...
| --- | --- |
| Уже выполнены #64, #79, #81, #82, #91, #117, #151, #210, #211, #213, #219, #220 и identity/reconciliation foundation | Готовая очередь #110; #94 и #74 тоже архитектурно готовы, но стоят сразу после текущего source gate из-за большего scope |
