...
Текущий baseline: **main 0.58.10**, build 180. Полная локальная проверка:
1338 XCTest (5 штатных пропусков) и 28 Swift Testing; сборка и живая приёмка Xcode 27.
CI проверил тесты и упаковку на macOS 26; Xcode 27 проверен локально.
...
Сверка после первоначального merge #291: 57 открытых issues; 12 сентября 2026 года
#291 переоткрыта после непройденного уголовного сценария (итого 58), она возвращена в очередь ниже.
...
### Незавершённая приёмка апелляционного маршрута

- **[#291](https://github.com/arvidsever/Sudrf/issues/291)** — 12 сентября 2026 года на сохранённом уголовном деле `2-12/2025` подтверждён пустой список вышестоящих судов: справочник не сопоставлял `oblsud--sam.sudrf.ru` с точечной формой домена. Исправление общего сопоставления и регрессионные тесты в `codex/asoy-domain-alias-291`; до закрытия обязательны штатное обновление досье и сохранение `55-584/2025` после перезапуска. Предыдущая приёмка уголовного сценария была неполной.
