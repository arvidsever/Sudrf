...
Текущий baseline: **main 0.58.24**, build 194. Полный локальный набор:
1425 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
...
Сверка 20 сентября 2026 года: после завершения #288 и #287 остаётся 47 открытых issue.
...
- **[#290](https://github.com/arvidsever/Sudrf/issues/290)** — восстановить подтверждённые нижестоящие карточки для `22-227/2020`; диагностика цепочки отделена от определения стадии #289. Цепочка `88-18789/2020` восстановлена в #287/#288.
