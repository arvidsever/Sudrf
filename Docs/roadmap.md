...
Текущий baseline: **main 0.58.22**, build 192. Полный локальный набор:
1416 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
...
Сверка 19 сентября 2026 года: после завершения #285, #286 и #289 остаётся 49 открытых issue.
