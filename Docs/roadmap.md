...
Текущий baseline: **main 0.55.1**, build 157, 1080 тестов (5 пропущены). Следующая
...
- **#164** проходит в два доказательных шага. 0.53.2 локально накапливает только
  ...
  после завершённой #74 ближайшая задача — **#92**: добавление дела в
  отслеживание по прямой ссылке на карточку суда.
...
| --- | --- |
| Уже выполнены #64, #74, #79, #81, #82, #88, #89, #90, #91, #94, #110, #117, #130, #132, #151, #207, #210, #211, #213, #219, #220 и identity/reconciliation foundation | #92 — ближайшая готовая задача |
| Выполненные #88 + этап 1 #164 | #92: добавление дела по URL использует единый надёжный CAPTCHA/session flow |
...
#74 завершена; ближайшая задача — #92. #93 ждёт именно event contract,
