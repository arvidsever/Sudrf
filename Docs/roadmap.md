...
Текущий baseline: **main 0.58.4**, build 174, 1240 XCTest (5 пропущены) и 20 Swift Testing. Полный
...
- **0.58.0 / #224:** федеральный LegalCalendar 2013–2026 принят; исторические и региональные пробелы остаются в issue.
...
- **[#273](https://github.com/arvidsever/Sudrf/issues/273)** — номер материала в ленте изменений. Критерии и границы — в issue.

### 1. Следующая короткая задача
...
- Выпущенный [#133](https://github.com/arvidsever/Sudrf/issues/133) не зависит от #179; [#101](https://github.com/arvidsever/Sudrf/issues/101) и [#273](https://github.com/arvidsever/Sudrf/issues/273) остаются отдельными задачами.
