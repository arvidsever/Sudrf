...
Текущий baseline: **main 0.58.5**, build 175, 1251 XCTest (5 пропущены) и 21 Swift Testing. Полный
...
- **[#45](https://github.com/arvidsever/Sudrf/issues/45)** — восстановить оформление однострочных актов с сохранением контракта
  paragraphizer version и цитат. По решению от 10 сентября 2026 года старые акты также переразбиваются; прежние сводки сохраняются как устаревшие, несовместимые переходы по ¶ отключаются. AI-генерация не запускается.
