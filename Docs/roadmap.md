...
Текущий baseline: **0.59.0**, build 210; локальный полный набор: 1608 XCTest
(5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode Debug build прошёл.
...
- **[#339](https://github.com/arvidsever/Sudrf/issues/339)** — при добавлении дела
  автоматически проходить CAPTCHA связанных судов и продолжать независимые проверки;
  частичный результат не объявлять полным успешным обходом.
