...
Текущий baseline: **main 0.46.9**, build 136, 865 тестов (10 пропущены). Следующее
исправление — 0.46.10; следующая пользовательская функция или новый источник — 0.47.0.
...
совпадает. Все 52 открытых issues перечислены в этом разделе.
