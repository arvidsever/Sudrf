...
Текущий baseline: **main 0.58.17**, build 187. Полный локальный набор:
1399 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
Приёмка #246 проведена на изолированной дисковой базе: обновление, частичный ответ и перезапуск не откатывают актуальную регистрацию.
...
|---|---|---|---|
| 0.58.17 | [#246](https://github.com/arvidsever/Sudrf/issues/246) | Актуальная гражданская регистрация после отмены возврата; прежние карточки и сроки сохранены исторически. | — |
...
Сверка 16 сентября 2026 года: после завершения #246 остаётся 54 открытых issues.
