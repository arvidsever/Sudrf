...
Текущий baseline: **main 0.58.18**, build 188. Полный локальный набор:
1403 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
Приёмка #86 проведена на изолированной дисковой базе: effective legal-force status сохраняется после partial refresh и перезапуска без ложных событий.
...
Сверка 16 сентября 2026 года: после завершения #86 остаётся 53 открытых issues.
