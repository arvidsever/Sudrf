...
Текущий baseline: **main 0.50.0**, build 147, 946 тестов (5 пропущены). Следующее
исправление — 0.50.1; следующая пользовательская функция или новый источник — 0.51.0.
...
совпадает. После merge #219 все 54 открытых issues перечислены в этом разделе.
...
- **#220** — синхронизировать регион и суд в обе стороны для областного,
  апелляционного и кассационного звена; family-specific поля #219 уже готовы.
...
| --- | --- |
| Уже выполнены #64, #79, #81, #82, #91, #117, #151, #210, #213, #219 и identity/reconciliation foundation | Готовая очередь #211, #220 и #110; #94 и #74 тоже архитектурно готовы, но стоят сразу после текущего source gate из-за большего scope |
