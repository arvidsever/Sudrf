...
Текущий baseline: **main 0.53.2**, build 152, 1005 тестов (5 пропущены). Следующая
...
- **#164** проходит в два доказательных шага. 0.53.2 локально накапливает только
  ...
  независимого eligibility-gate. Пока корпус накапливается, ближайшие исполнимые
  задачи source gate — **#88 + #89**.
