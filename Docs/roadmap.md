...
Текущий baseline: **0.58.39**, build 209. Для #342 прошли целевой тест,
...
Сверка 26 сентября 2026 года: 54 открытых issues; все распределены ниже.
...
- **[#332](https://github.com/arvidsever/Sudrf/issues/332)** — информативный месяц:
  стороны и суд в карточках, накладки разных судов, компактный режим и «ещё N».
  Не меняет неделю, схему данных и расчёт сроков. В работе в [PR #335](https://github.com/arvidsever/Sudrf/pull/335); визуальная приёмка автором ещё впереди.
