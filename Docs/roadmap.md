...
Текущий baseline: **main 0.58.21**, build 191. Полный локальный набор:
1411 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
...
|---|---|---|---|
| 0.58.21 | [#309](https://github.com/arvidsever/Sudrf/issues/309) | Будущее заседание последующей кассации имеет приоритет над неоднозначной историей апелляций. | — |
...
Сверка 17 сентября 2026 года: после завершения #309 остаётся 52 открытых issue.
