# Captcha auto-solver — v0.39.14 (draft, in progress)

> Forecast version. Final number assigned at merge.
> Drafted 2026-07-10. Branch: `captcha-auto-solver` (A2 на отдельной
> рабочей ветке `claude/a2-captcha-rejected-error-njgh6k` для ревью).
> Status: build green, 313 tests pass (312 из v0.39.13 + 1 новый).
