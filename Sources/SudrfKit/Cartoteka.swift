...
public enum CartotekaRegistry {
    ...
    public static let subject: [Cartoteka] = [
        ...
        Cartoteka(id: "adm33", title: "АП: на вступившие в силу (суд субъекта)",
                  prefixes: ["4а", "п4а"],
            ...
            // Пересмотр вступивших в силу актов судом субъекта: исторические
            // производства до 01.10.2019 и MS-цепочки снова с 10.05.2026.
            // Остальные современные производства рассматривает КСОЮ.
    ]
