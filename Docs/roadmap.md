...
Текущий baseline: **main 0.57.5**, build 166, 1184 теста (5 пропущены). Полный
...
После последовательного merge #239/#265 и регистрации #269 остаются
**56 открытых issues**, все распределены
...
- **[#269](https://github.com/arvidsever/Sudrf/issues/269)** — в работе: точные карточки
  апелляции/кассации, найденные по УИД, должны связывать отдельно сохранённые досье,
  в том числе при частичном обновлении. Старые записи исправляются по сохранённой
  связи без обязательной новой загрузки; материалы исключены, TTL и ошибки сохраняются.
  Приёмка: пары 5-469/2026 ↔ 16-5132/2026 и 5-470/2026 ↔ 16-4990/2026,
  сохранность подборок и истории, повторная подготовка без изменений.
