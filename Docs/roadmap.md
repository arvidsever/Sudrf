...
Текущий baseline: **main 0.58.19**, build 189. Полный локальный набор:
1408 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
Приёмка #275 проведена на изолированной дисковой базе: завершённая кассационная жалоба сохраняет точный результат после partial refresh, временной ошибки и перезапуска без ложных событий.
...
|---|---|---|---|
| 0.58.19 | [#275](https://github.com/arvidsever/Sudrf/issues/275) | Возврат кассационной жалобы по подсудности завершает производство без изменения статуса законной силы. | — |
...
Сверка 16 сентября 2026 года: после завершения #275 остаётся 52 открытых issues.
...
- **[#276](https://github.com/arvidsever/Sudrf/issues/276)** — восстановить связанную цепочку для карточки `8Г-162/2019`; lifecycle возвращённой жалобы исправлен отдельно в #275.
