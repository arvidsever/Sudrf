...
Текущий baseline: **main 0.47.3**, build 144, 913 тестов (5 пропущены). Следующее
исправление — 0.47.4; следующая пользовательская функция или новый источник — 0.48.0.
...
совпадает. После merge #210 все 49 открытых issues перечислены в этом разделе.
...
| --- | --- |
| Уже выполнены #64, #79, #81, #82, #91, #117, #210 и identity/reconciliation foundation | Готовая очередь #151 → #213, #211 и #110; #94 и #74 тоже архитектурно готовы, но стоят сразу после текущего source gate из-за большего scope |
