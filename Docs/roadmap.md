...
|---|---|---|---|
| 0.58.29 | [#319](https://github.com/arvidsever/Sudrf/issues/319) | Итоговые определения получают правильный срок, завершённые производства и самостоятельные материалы больше не остаются в первой инстанции. | — |
...
Сверка 22 сентября 2026 года: после завершения #319 остаётся 43 открытых issue.
