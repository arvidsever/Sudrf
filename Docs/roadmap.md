...
Текущий baseline: **main 0.46.10**, build 137, 868 тестов (10 пропущены). Следующее
исправление — 0.46.11; следующая пользовательская функция или новый источник — 0.47.0.
...
совпадает. После merge #187 все 51 открытых issues перечислены в этом разделе.
...
- **#79** — устранить ложный «неизвестный формат» при рабочей HTML-выдаче районного
  суда и расхождении canonical host. Затем source gate продолжают **#78 + #82 + #88 +
  #164 + #89**: honest zero, CAPTCHA continuation/session и пригодное движение КСОЮ;
