...
Текущий baseline: **main 0.46.5**, build 132, 830 тестов (5 пропущены). Следующее
исправление — 0.46.6; следующая пользовательская функция или новый источник — 0.47.0.
