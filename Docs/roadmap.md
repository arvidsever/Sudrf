...
Текущий baseline: **main 0.47.0**, build 141, 900 тестов (5 пропущены). Следующее
исправление — 0.47.1; следующая пользовательская функция или новый источник — 0.48.0.
...
совпадает. После merge #91 все 48 открытых issues перечислены в этом разделе.
...
| --- | --- |
| Уже выполнены #64, #79, #82, #91 и identity/reconciliation foundation | Готовая очередь #81, #117, #151, #110; #94 и #74 тоже архитектурно готовы, но стоят сразу после текущего source gate из-за большего scope |
