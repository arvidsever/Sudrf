    ...
    var body: some View {
        Form {
            Section("Фоновая проверка") {
                ...
                Text("Отслеживаемые дела обновляются в фоне с этим интервалом. Движение без кэша загружается при первом открытии карточки. Проверить всё немедленно можно значком обновления в «Мои дела».")
