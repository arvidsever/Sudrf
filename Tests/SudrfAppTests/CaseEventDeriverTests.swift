...
struct CaseEventDeriverTests {
    ...
    @Test func derivationVersionFourBaselinesVersionThreeProjectionAndPreservesJournal() throws {
        ...
        #expect(decoded.events == [event])
        #expect(CaseEventJournal.currentDerivationVersion == 4)
