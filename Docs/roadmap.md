...
Текущий baseline: **main 0.58.14**, build 184. Последняя полная локальная проверка приложения — в 0.58.13:
1360 XCTest (5 штатных пропусков) и 28 Swift Testing, сборка Xcode 27 и живая
приёмка с перезапуском. Результаты CI указаны в PR [#301](https://github.com/arvidsever/Sudrf/pull/301).
...
Сверка 12 сентября 2026 года: 57 открытых issues после завершения #300; #291 закрыта после приёмки и merge #298.
