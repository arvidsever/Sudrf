...
struct TrackedCase: Identifiable {
    ...
    var court: String
    /// Суд записи — суд первой инстанции, в котором дело отслеживается. Не
    /// показывается, но участвует в фильтре: дело, ушедшее в апелляцию, должно
    /// по-прежнему находиться по названию своего суда первой инстанции.
    var recordCourt: String
