...
Текущий baseline: **main 0.46.11**, build 138, 874 теста (10 пропущены). Следующее
исправление — 0.46.12; следующая пользовательская функция или новый источник — 0.47.0.
...
совпадает. После merge #79 все 50 открытых issues перечислены в этом разделе.
...
- **#78 + #82 + #88 + #164 + #89** продолжают source gate: honest zero, CAPTCHA
