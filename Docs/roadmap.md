...
Текущий baseline: **0.58.35**, build 205; CI `swift build && swift test` на macOS 26 зелёный.
Последний полный локальный набор (0.58.34): 1517 XCTest (5 штатных пропусков) и 28 Swift
Testing, без ошибок; Xcode Debug build.
