...
Текущий baseline: **main 0.58.7**, build 177, 1310 XCTest (5 пропущены) и 21 Swift Testing. Полный
...
Сверка после #284: 58 открытых issues на 11 сентября 2026 года, каждая учтена в очереди.
...
- **#256** — полная опубликованная хронология жалоб КоАП КСОЮ: истребование, поступление истребованного дела и результат рассмотрения; согласованный итог и три вида событий shadow-журнала. Реализация в `codex/koap-complaint-timeline-256`; первый снимок новой версии остаётся baseline, уведомления работают по обычным правилам. #86, #262 и #179 остаются отдельно.
