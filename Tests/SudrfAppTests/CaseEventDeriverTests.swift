...
struct CaseEventDeriverTests {
    ...
    @Test func derivationVersionSixBaselinesVersionFiveProjectionAndPreservesJournal() throws {
        ...
        #expect(CaseEventJournal.currentDerivationVersion == 6)
