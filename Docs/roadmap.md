...
Текущий baseline: **0.58.38**, build 208; локальный полный набор: 1537 XCTest
(5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode Debug build прошёл.
CI текущего SHA — после PR.
...
Сверка 26 сентября 2026 года: 55 открытых issues; все распределены ниже.
...
- **[#342](https://github.com/arvidsever/Sudrf/issues/342)** — раскрыть Xcode Hang Risk,
  получить стек ожидания и устранить подтверждённую проблему отзывчивости.
  Соседние сообщения WebContent/XPC и долгое добавление дела не считать её доказательством.
