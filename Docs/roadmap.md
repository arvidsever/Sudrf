...
Текущий baseline: **main 0.58.25**, build 195. Полный локальный набор:
1432 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
...
Сверка 22 сентября 2026 года: после завершения #290 остаётся 46 открытых issue.
