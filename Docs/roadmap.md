...
Текущий baseline: **main 0.46.12**, build 139, 882 теста (10 пропущены). Следующее
исправление — 0.46.13; следующая пользовательская функция или новый источник — 0.47.0.
...
совпадает. После merge #78 все 49 открытых issues перечислены в этом разделе.
...
- **#82 + #88 + #164 + #89** продолжают source gate: CAPTCHA
