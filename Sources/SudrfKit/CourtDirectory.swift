...
public struct TerritorialCourt: Sendable, Equatable {
    ...
    public let title: String
    public let domain: String
    /// Код субъекта, где находится сам суд. Это не первый регион его
    /// территориальной подсудности: для обратной синхронизации он задаётся
    /// явно по официальному месту пребывания суда.
    public let seatRegionCode: String
...
public enum CourtDirectory {
    ...
    public static let cassationCourts: [TerritorialCourt] = [
        TerritorialCourt(number: 1, title: "Первый кассационный суд", domain: "1kas.sudrf.ru", seatRegionCode: "64", regions: ["Республика Мордовия", "Белгородская область", "Брянская область", "Воронежская область", "Калужская область", "Курская область", "Липецкая область", "Орловская область", "Московская область", "Нижегородская область", "Пензенская область", "Саратовская область", "Тульская область"]),
        TerritorialCourt(number: 2, title: "Второй кассационный суд", domain: "2kas.sudrf.ru", seatRegionCode: "77", regions: ["город Москва", "Владимирская область", "Ивановская область", "Костромская область", "Рязанская область", "Смоленская область", "Тамбовская область", "Тверская область", "Ярославская область"]),
        TerritorialCourt(number: 3, title: "Третий кассационный суд", domain: "3kas.sudrf.ru", seatRegionCode: "78", regions: ["город Санкт-Петербург", "Республика Карелия", "Республика Коми", "Архангельская область", "Вологодская область", "Калининградская область", "Ленинградская область", "Мурманская область", "Новгородская область", "Псковская область", "Ненецкий автономный округ"]),
        TerritorialCourt(number: 4, title: "Четвертый кассационный суд", domain: "4kas.sudrf.ru", seatRegionCode: "23", regions: ["город Севастополь", "Республика Адыгея (Адыгея)", "Республика Калмыкия", "Республика Крым", "Краснодарский край", "Астраханская область", "Волгоградская область", "Ростовская область"]),
        TerritorialCourt(number: 5, title: "Пятый кассационный суд", domain: "5kas.sudrf.ru", seatRegionCode: "26", regions: ["Республика Дагестан", "Республика Ингушетия", "Кабардино-Балкарская Республика", "Карачаево-Черкесская Республика", "Республика Северная Осетия - Алания", "Чеченская Республика", "Ставропольский край"]),
        TerritorialCourt(number: 6, title: "Шестой кассационный суд", domain: "6kas.sudrf.ru", seatRegionCode: "63", regions: ["Республика Башкортостан", "Республика Марий Эл", "Республика Татарстан (Татарстан)", "Удмуртская Республика", "Чувашская Республика - Чувашия", "Кировская область", "Оренбургская область", "Самарская область", "Ульяновская область"]),
        TerritorialCourt(number: 7, title: "Седьмой кассационный суд", domain: "7kas.sudrf.ru", seatRegionCode: "74", regions: ["Пермский край", "Курганская область", "Свердловская область", "Тюменская область", "Челябинская область", "Ханты-Мансийский автономный округ - Югра", "Ямало-Ненецкий автономный округ"]),
        TerritorialCourt(number: 8, title: "Восьмой кассационный суд", domain: "8kas.sudrf.ru", seatRegionCode: "42", regions: ["Республика Алтай", "Республика Бурятия", "Республика Тыва", "Республика Хакасия", "Алтайский край", "Забайкальский край", "Красноярский край", "Иркутская область", "Кемеровская область", "Новосибирская область", "Омская область", "Томская область"]),
        TerritorialCourt(number: 9, title: "Девятый кассационный суд", domain: "9kas.sudrf.ru", seatRegionCode: "25", regions: ["Республика Саха (Якутия)", "Камчатский край", "Приморский край", "Хабаровский край", "Амурская область", "Магаданская область", "Сахалинская область", "Еврейская автономная область", "Чукотский автономный округ"]),
    ]

    /// Апелляционные суды ОСЮ (1–5).
    public static let appealCourts: [TerritorialCourt] = [
        TerritorialCourt(number: 1, title: "Первый апелляционный суд", domain: "1ap.sudrf.ru", seatRegionCode: "77", regions: ["город Москва", "Московская область", "Белгородская область", "Брянская область", "Владимирская область", "Воронежская область", "Ивановская область", "Калининградская область", "Калужская область", "Костромская область", "Курская область", "Липецкая область", "Новгородская область", "Орловская область", "Псковская область", "Рязанская область", "Смоленская область", "Тамбовская область", "Тверская область", "Тульская область", "Ярославская область"]),
        TerritorialCourt(number: 2, title: "Второй апелляционный суд", domain: "2ap.sudrf.ru", seatRegionCode: "78", regions: ["город Санкт-Петербург", "Ленинградская область", "Республика Карелия", "Республика Коми", "Архангельская область", "Вологодская область", "Курганская область", "Мурманская область", "Свердловская область", "Тюменская область", "Челябинская область", "Ненецкий автономный округ", "Ханты-Мансийский автономный округ - Югра", "Ямало-Ненецкий автономный округ"]),
        TerritorialCourt(number: 3, title: "Третий апелляционный суд", domain: "3ap.sudrf.ru", seatRegionCode: "23", regions: ["город Севастополь", "Республика Адыгея (Адыгея)", "Республика Дагестан", "Республика Ингушетия", "Кабардино-Балкарская Республика", "Республика Калмыкия", "Карачаево-Черкесская Республика", "Республика Крым", "Республика Северная Осетия - Алания", "Чеченская Республика", "Краснодарский край", "Ставропольский край", "Астраханская область", "Волгоградская область", "Ростовская область"]),
        TerritorialCourt(number: 4, title: "Четвертый апелляционный суд", domain: "4ap.sudrf.ru", seatRegionCode: "52", regions: ["Республика Башкортостан", "Республика Марий Эл", "Республика Мордовия", "Республика Татарстан (Татарстан)", "Удмуртская Республика", "Чувашская Республика", "Пермский край", "Кировская область", "Нижегородская область", "Оренбургская область", "Пензенская область", "Самарская область", "Саратовская область", "Ульяновская область"]),
        TerritorialCourt(number: 5, title: "Пятый апелляционный суд", domain: "5ap.sudrf.ru", seatRegionCode: "54", regions: ["Республика Алтай", "Республика Бурятия", "Республика Саха (Якутия)", "Республика Тыва", "Республика Хакасия", "Алтайский край", "Забайкальский край", "Камчатский край", "Красноярский край", "Приморский край", "Хабаровский край", "Амурская область", "Иркутская область", "Кемеровская область", "Магаданская область", "Новосибирская область", "Омская область", "Сахалинская область", "Томская область", "Еврейская автономная область", "Чукотский автономный округ"]),
    ]
