...
Текущий baseline: **main 0.51.0**, build 148, 951 тест (5 пропущены). Следующее
исправление — 0.51.1; следующая пользовательская функция или новый источник — 0.52.0.
...
совпадает. После merge #211 все 53 открытых issues перечислены в этом разделе.
...
| --- | --- |
| Уже выполнены #64, #79, #81, #82, #91, #117, #151, #210, #211, #213, #219 и identity/reconciliation foundation | Готовая очередь #220 и #110; #94 и #74 тоже архитектурно готовы, но стоят сразу после текущего source gate из-за большего scope |
