...
Текущий baseline: **main 0.58.20**, build 190. Полный локальный набор:
1409 XCTest (5 штатных пропусков) и 28 Swift Testing, без ошибок; Xcode 27 build.
...
Сверка 16 сентября 2026 года: после завершения #276 остаётся 51 открытый issue.
