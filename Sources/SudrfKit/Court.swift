...
/// Военные суды работают на той же платформе sud_delo. Набор картотек формы
/// определяется парой «ветвь + звено», а не одним `CourtLevel`: точные
/// матрицы военных звеньев задаёт `CartotekaRegistry`.
