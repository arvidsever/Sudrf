...
- **[#233](https://github.com/arvidsever/Sudrf/issues/233)** — исправлено в 0.58.4 (174), [PR #281](https://github.com/arvidsever/Sudrf/pull/281): выбор пяти фильтров применяется после выхода из обработчика SwiftUI; старые запросы инвалидируются сразу.
  Профильные и полные тесты, сборка Xcode 27 и живая приёмка пяти фильтров пройдены; issue закрыта. [#230](https://github.com/arvidsever/Sudrf/issues/230) остаётся отдельной проверкой.
