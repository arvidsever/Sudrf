# Captcha auto-solver — v0.39.18 (draft, in progress)

> Forecast version. Final number assigned at merge.
> Drafted 2026-07-10. Branch: `captcha-auto-solver`
> (A15 на отдельной рабочей ветке `claude/a15-captcha-deadlock-njgh6k`
> для ревью).
> Status: build green, 335 tests pass (317 из v0.39.17 + 18 новых).
