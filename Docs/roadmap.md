...
Текущий baseline: **main 0.56.0**, build 158, 1100 тестов (5 пропущены). Следующее
исправление выпускается как 0.56.1.
...
- **#164** проходит в два доказательных шага. 0.53.2 локально накапливает только
  ...
  После завершённой #92 ближайшая задача — **#56**: узкое correctness-исправление
  lifecycle и ложного срока апелляции при живой кассации.
...
| --- | --- |
| Уже выполнены #64, #74, #79, #81, #82, #88, #89, #90, #91, #92, #94, #110, #117, #130, #132, #151, #207, #210, #211, #213, #219, #220 и identity/reconciliation foundation | #56 — ближайшая готовая correctness-задача |
...
#92 завершена; ближайшая задача — #56. #93 ждёт именно event contract,
